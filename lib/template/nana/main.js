...
`
  if (ga) {
    fs.copyFileSync(path.resolve(__dirname, './ga/gtag.js'), path.resolve(targetDir, './src/assets/script/gtag.js'))
    fs.copyFileSync(path.resolve(__dirname, './ga/Voice-ga.vue'), path.resolve(targetDir, './src/components/Voice.vue'))
  } else {
    fs.copyFileSync(path.resolve(__dirname, './ga/Voice.vue'), path.resolve(targetDir, './src/components/Voice.vue'))
  }
  if (pwa) {
    fs.copyFileSync(path.resolve(__dirname, './pwa/registerServiceWorker.js'), path.resolve(targetDir, './src/registerServiceWorker.js'))
  }
